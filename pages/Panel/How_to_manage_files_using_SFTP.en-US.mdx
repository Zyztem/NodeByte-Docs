...
2. **Enter your server's details:**
   - For [WinSCP](https://winscp.net/eng/index.php), go to `New Site`
   - For [FileZilla](https://filezilla-project.org/), go to `File > Site Manager > New Site`.
   - For [Cyberduck](https://cyberduck.io/), go to `File > New Connection`.
